...
/**
 * Helps with conversion between units of time. Similar in spirit to {@link java.util.concurrent.TimeUnit}, but
 * the conversion method uses double and does not truncate.
 *
 * @author Eric Bottard
 */
